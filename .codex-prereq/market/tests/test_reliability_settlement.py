...
from market.models import AdjustmentStatus, Exchange, PredictionSnapshot, PriceHistory, Stock
...
class SettlementCorrectnessTests(TestCase):
    ...
    def test_implausible_return_is_excluded_instead_of_scored(self):
        ...
        self.assertEqual(snap.exclusion_reason, "implausible_outcome_return")
        self.assertIsNone(snap.outcome_return)
    ...
    def test_adjusted_and_raw_price_pair_is_excluded(self):
        ...
        snap.refresh_from_db()
        self.assertEqual(snap.settlement_status, PredictionSnapshot.SettlementStatus.EXCLUDED)
        self.assertEqual(snap.exclusion_reason, "inconsistent_adjustment_status")
